partial class ADAM_AutoIO_HtoL_Latch_Form
{
    /// <summary>
    /// 設計工具所需的變數。
    /// </summary>
    ...
    private void InitializeComponent()
    {
        ...
        this.label16.Text = "DI-H to L latch";
        // 
        // label7
        // 
        ...
        this.Text = "ADAM_AutoIO_HtoL_Latch";
        this.Load += new System.EventHandler(this.ADAM_AutoIO_HtoL_Latch_Load);
