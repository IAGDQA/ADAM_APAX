partial class ADAM_AutoIO_Di_Value_Form
{
    /// <summary>
    /// 設計工具所需的變數。
    /// </summary>
    ...
    private void InitializeComponent()
    {
        ...
        this.Name = "ADAM_AutoIO_Di_Value_Form";
        this.Text = "ADAM_AutoIO_Di_Value";
        this.Load += new System.EventHandler(this.ADAM_AutoIO_Di_Value_Load);
