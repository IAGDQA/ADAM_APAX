partial class ADAM_AutoIO_Di_FreqMode_Form
{
    /// <summary>
    /// 設計工具所需的變數。
    /// </summary>
    ...
    private void InitializeComponent()
    {
        ...
        this.label16.Text = "DI- Freq Mode";
        // 
        // label7
        // 
        ...
        this.Text = "ADAM_AutoIO_Di_FreqMode";
        this.Load += new System.EventHandler(this.ADAM_AutoIO_Di_FreqMode_Load);
